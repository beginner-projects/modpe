    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <div className="mx-auto mt-6 max-w-2xl lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          ...
          <div className="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3">
            <Image
        ...
        {/* Product info */}
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
